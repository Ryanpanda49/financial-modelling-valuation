...
| Phase 1 — SEC data layer | Complete live for five companies | Client, compression decoding, cache, limiter, ticker/CIK lookup, Company Facts parser, revenue-anchored annual selector, synthetic fixtures, and WMT/AAPL/COST/KO/MSFT live retrieval. |
| Phase 2 — Standardized history | Complete live for five companies | Each public fixture contains five fiscal years and 330 provenance records, no required mapping issues, balanced statements, and exact cash roll-forwards. |
